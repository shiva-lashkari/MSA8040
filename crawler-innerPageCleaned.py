...
with open('rawData.csv', 'r') as file:
    ...
    for row in reader:
        ...
        participant_line=[conference_id,conference_url,comapnyParticipants, corporateParticipants, executiveParticipants, callParticipants, operator, QA, Presentation]
